...
export default function EmployeeRegistrationDialog({
  ...
  return (
    ...
    >
      <DialogTitle sx={{ pb: 1 }}>
        <div className="text-2xl font-bold text-slate-900">従業員を登録</div>
        <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
          `infra/README.md` の User テーブル定義に合わせて、ログイン ID・メールアドレス・所属部署・権限を登録します。
        </Typography>
      </DialogTitle>
      ...
      <DialogContent sx={{ pt: "8px !important" }}>
        <Stack spacing={2.5}>
          ...
          <Alert severity="info">
            連絡先や住所は User テーブルに含まれないため、この画面では管理しません。Cognito 連携は初回ログイン後に反映されます。
          </Alert>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <FormControl fullWidth error={hasSubmitted && validation.departmentName}>
              <InputLabel id="employee-registration-department-label">所属部署</InputLabel>
              <Select
                labelId="employee-registration-department-label"
