...
const CATEGORY_OPTIONS: Array<{ value: SupportInquiryCategory; label: string }> = [
  ...
  { value: "MERCHANDISE", label: "商品・サービス" },
  { value: "EXCHANGE", label: "交換管理" },
...
export default function SupportInquiryForm({ merchantUserName, merchantDisplayName }: Props) {
  const [category, setCategory] = useState<SupportInquiryCategory>("MERCHANDISE");
  ...
  return (
    <div className="space-y-6 pb-10">
      <AdminPageHeader
        ...
        subtitle="商品・交換・請求などの確認事項を送信します"
      />
