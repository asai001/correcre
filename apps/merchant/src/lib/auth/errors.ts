export const LOGIN_ERROR_MESSAGES = {
  ...
  password_reset_required: "パスワードの再設定が必要です。パスワードを変更してから、もう一度ログインしてください。",
  ...
  user_not_confirmed: "アカウントの確認が完了していません。管理状態を確認してください。",
  merchant_role_not_allowed: "提携企業画面にログインする権限がありません。",
