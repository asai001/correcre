...
import type { OperatorCompanyPhilosophyItem } from "../model/types";
import type { CompanyPhilosophyItemValidation } from "./company-form";

type CompanyPhilosophyFieldsProps = {
  items: OperatorCompanyPhilosophyItem[];
  validation: CompanyPhilosophyItemValidation[];
  hasSubmitted: boolean;
  onAdd: () => void;
  onChangeItem: (itemId: string, nextItem: Partial<OperatorCompanyPhilosophyItem>) => void;
